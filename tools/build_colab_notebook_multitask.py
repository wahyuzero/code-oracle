...
cells_raw = [
    ...
    },
    {
        ...
        "content": [
            ...
            "",
            "# 2. Optimize temperature T via L-BFGS with smooth parametrization bounded in [0.8, 2.5]",
            ...
            "    # Smooth parametrization guarantees T in (0.8, 2.5) with continuous non-zero gradients everywhere",
